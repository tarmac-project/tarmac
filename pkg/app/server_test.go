...
const testWASMPath = "../../testdata/base/default/tarmac.wasm"
...
func TestBasicFunction(t *testing.T) {
	...
	cfg.Set("wasm_function", testWASMPath)
	...
	if err := waitForServer("http://localhost:9001/health"); err != nil {
...
func TestWASMHandlerHTTPMethods(t *testing.T) {
	...
	if err := waitForServer("http://localhost:9002/health"); err != nil {
		t.Fatalf("Server failed to start: %v", err)
	}
...
func TestWASMHandlerWithFailingModule(t *testing.T) {
	...
	if err := waitForServer("http://localhost:9003/health"); err != nil {
		t.Fatalf("Server failed to start: %v", err)
	}
...
func TestRunWASMWithFailingModule(t *testing.T) {
	...
	if err := waitForServer("http://localhost:9004/health"); err != nil {
		t.Fatalf("Server failed to start: %v", err)
	}
